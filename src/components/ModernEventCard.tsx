    ...
    >
      <div className="aspect-[4/5] relative overflow-hidden bg-gray-200">
        ...
        <div className="absolute top-3 right-3">
          <Badge className={`bg-gradient-to-r ${getCategoryGradient(event.category)} text-white border-0 shadow-lg backdrop-blur-sm`}>
            {event.category}
          </Badge>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-bold text-xl leading-tight mb-1 line-clamp-2">
                {event.title}
              </h3>
