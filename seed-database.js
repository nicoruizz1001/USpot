...
/**
 * Standalone script to seed the database with real UVA building data
...
async function seedBuildings() {
  ...
  for (const buildingData of uvaBuildings) {
    ...
    if (buildingError) {
      console.error(`❌ Error inserting building ${buildingData.building}:`, buildingError.message);
      continue;
    }
  ...
  console.log('\n🎉 You can now view the buildings in the Lock-In section!');
}
